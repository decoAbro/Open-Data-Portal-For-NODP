...
const initialTables = [
  ...
  "Non Teachers Profile",
  "Institutions Other Facilities",
  "Enrolment ECE Experience",
  "Enrolment Refugee",
  "Enrolment Religion",
  ...
  "Building",
  "Repeaters",
  "Teaching Non Teaching Category",
  "Teaching Non Teaching Designation",
  "Teachers Professional Qualification",
  "Teachers Academic Qualification",
  "ECE Facilities",
  "Sanctioned Teaching Non Teaching",
  "Student Profile",
]

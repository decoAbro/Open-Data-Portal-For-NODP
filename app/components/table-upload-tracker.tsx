            ...
            {selectedFile && (
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  {/* Display Census Year if available in the file data */}
                  <div>
                    <span className="text-blue-700 font-medium">Census Year:</span>
                    <span className="ml-2 text-blue-800">
                      {(() => {
                        if (parsedJsonData && selectedTable && parsedJsonData[selectedTable] && parsedJsonData[selectedTable].length > 0) {
                          // Try to find Census_Year or census_year in the first record
                          const firstRecord = parsedJsonData[selectedTable][0];
                          return firstRecord.Census_Year || firstRecord.census_year || "Not found";
                        }
                        return "Not found";
                      })()}
                    </span>
                  ...
                  <div ref={pdfMetaRef}>
                    <div className="mb-4 p-4 border-b border-gray-300">
                      ...
                      <div className="text-sm text-gray-700">
                        ...
                        <div><strong>Census Year:</strong> {(() => {
                          if (parsedJsonData && selectedTable && parsedJsonData[selectedTable] && parsedJsonData[selectedTable].length > 0) {
                            const firstRecord = parsedJsonData[selectedTable][0];
                            return firstRecord.Census_Year || firstRecord.census_year || "Not found";
                          }
                          return currentYear || "Not found";
                        })()}</div>
                      </div>
                    </div>
                    <div>
